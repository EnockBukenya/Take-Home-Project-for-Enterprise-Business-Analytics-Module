...
df_duplicate = df.loc[[3]]  # Select the row to duplicate
...
# Additional sample data for the dataset
additional_data = {
    "Branch": ["Kampala", "Gulu", "Mbarara", "Jinja", "Arua"],
    "Region": ["Central", "Northern", "Western", "Eastern", "West Nile"],
    "Branch Manager": ["Alice", "Bob", "Charlie", "David", "Eve"]
}
...
# Integrate the additional dataset with the original dataset
df_integrated = pd.merge(df, df_additional, on="Branch", how="left")
